/**
 * Author: Github@acmeism
 * Retrieved via: https://github.com/acmeism/RosettaCodeData/blob/master/Task/Tic-tac-toe/C/tic-tac-toe.c
 * Usage: code sample to test color scheme
 */
#include <stdio.h>
#include <stdlib.h>
...
/**
 * check throughout the board to find the winner
 * @keyworderror none
 * @return int: 1/-1 if human/computer wins
 *              0    if no winner yet
 */
int check_winner()
{
